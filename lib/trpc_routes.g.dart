...
class exampleRouteInput with _$exampleRouteInput {
  ...
  factory exampleRouteInput.fromJson(Map<String, dynamic> json) =>
      _$exampleRouteInputFromJson(json);
}
...
class exampleRouteOutput with _$exampleRouteOutput {
  ...
  factory exampleRouteOutput.fromJson(Map<String, dynamic> json) =>
      _$exampleRouteOutputFromJson(json);
}
